...
protocol SearchSortingChanged: NSObject {
...
class SearchSortViewController: UIViewController {
    ...
    var viewModel: SearchSortViewModel?
    weak var sortDelegate: SearchSortingChanged?
    ...
    private func setupTableView() {
        ...
        tableView.register(UINib(nibName: SearchSortCell.nibName, bundle: Bundle.main), forCellReuseIdentifier: SearchSortCell.reuseIdentifier)
    }
...
extension SearchSortViewController: SearchSortViewControllerDelegate {
...
extension SearchSortViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: SearchSortCell.reuseIdentifier, for: indexPath) as? SearchSortCell, let sortItem = viewModel?.sortItems[indexPath.row] {
